        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthPackageRegistrationId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Invoices_SingleSource", "([AppointmentId] IS NOT NULL AND [HealthPackageRegistrationId] IS NULL) OR ([AppointmentId] IS NULL AND [HealthPackageRegistrationId] IS NOT NULL)");
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_HealthPackageRegistrations_HealthPackageRegistrationId",
                        column: x => x.HealthPackageRegistrationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InvoiceItems_LineTotal_NonNegative", "[LineTotal] >= 0");
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_Specialties_ConsultationFee_NonNegative",
                table: "Specialties",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[AppointmentId] IS NOT NULL AND [Status] <> 3");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_HealthPackageRegistrationId",
                table: "Invoices",
                column: "HealthPackageRegistrationId",
                unique: true,
                filter: "[HealthPackageRegistrationId] IS NOT NULL AND [Status] <> 3");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_PatientId_CreatedAtUtc",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ReceivedAtUtc",
                table: "Payments",
