...
public class Program
{
    ...
    private static int RunTrainIntent(string dataPath, string outDir)
    {
        ...
        Console.WriteLine($"Metadata exported: {result.MetadataPath}");
        Console.WriteLine("=========================================================");
        Console.WriteLine("BENCHMARK RESULTS ON INDEPENDENT TEST SPLIT:");
        Console.WriteLine($"Total Test Samples: {result.Benchmark.TotalTestSamples}");
        Console.WriteLine($"  - ML.NET Model Accuracy:       {result.Benchmark.MlNetAccuracy:P2} ({result.Benchmark.MlNetCorrect}/{result.Benchmark.TotalTestSamples})");
        Console.WriteLine($"  - Rule-Based Baseline Accuracy: {result.Benchmark.RuleBasedAccuracy:P2} ({result.Benchmark.RuleBasedCorrect}/{result.Benchmark.TotalTestSamples})");
        Console.WriteLine($"  - ML.NET Micro Accuracy:       {result.Benchmark.MlNetMetrics.MicroAccuracy:P2}");
        Console.WriteLine($"  - ML.NET Macro Accuracy:       {result.Benchmark.MlNetMetrics.MacroAccuracy:P2}");
